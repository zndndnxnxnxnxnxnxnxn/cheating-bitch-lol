...
if(url != 'https://kbhgames.com/'){
	...
	if(Math.random() < 0.5){
	window.document.body.insertAdjacentHTML( 'beforeend','<div id="playmore"><a href="https://kbhgames.com/tag/friday-night-funkin" target="_top">Play More Games &#187;</a></div>');
		
	}else{
	window.document.body.insertAdjacentHTML( 'afterbegin','<div id="playmore"><a href="https://kbhgames.com/tag/friday-night-funkin" target="_top">Play More Games &#187;</a></div>');
	}
